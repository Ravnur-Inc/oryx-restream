...
export const BG            = "var(--mantine-color-body)";                   // page background
export const CARD          = "var(--mantine-color-body)";                   // card surface (+ border)
export const PANEL         = "var(--mantine-color-default)";                // subtle inset surface
